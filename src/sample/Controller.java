...
public class Controller {
    ...
    public void showAddContactDialog() {
        ...
        checkLoadDialog(dialog, fxmlLoader);
    ...
    public void showEditContactDialog() {
        ...
        if (isSelectedContactNull(selectedContact))
            return;
    ...
    private boolean isSelectedContactNull(Contact selectedContact) {
    ...
    private void checkLoadDialog(Dialog<ButtonType> dialog, FXMLLoader fxmlLoader) {
        try {
